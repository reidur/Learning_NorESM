...
USER="reidur"
project='nn91880k' #nn8057k: EMERALD, nn2806k: METOS, nn9188k: CICERO, nn9560k: NorESM (INES2), nn9039k: NorESM (UiB: Climate predition unit?), nn2345k: NorESM (EU projects)
machine='betzy'
...
casename="n1850.$resolution.$noresmversion.Run9-1.`date +"%Y-%m-%d"`"
...
then
    ...
    cp /cluster/work/users/reidur/archive/$refcase/rest/$refyear-01-01-00000/*.r*.nc /cluster/work/users/reidur/noresm/$casename/run/ 
    cp /cluster/work/users/reidur/archive/$refcase/rest/$refyear-01-01-00000/rpointer.*$refyear-01-01-00000 /cluster/work/users/reidur/noresm/$casename/run/ 
    cp /cluster/work/users/reidur/archive/$refcase/rest/$refyear-01-01-00000/$refcase.cam.i.$refyear-01-01-00000.nc /cluster/work/users/reidur/noresm/$casename/run/ 
